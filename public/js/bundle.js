...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFycmlzMjIyMyIsImEiOiJja2w1eWhrd2QxMzJpMm5tZ2FsZjAxYnIyIn0.b7Kj3qj9zg8TrXersgjDbg';
  ...
  if (locations.length !== 0) {
    locations.forEach(function (loc) {
      ...
      var coordinates = [loc.lon, loc.lat]; // Add marker

      new mapboxgl.Marker({
        element: el,
        anchor: 'bottom'
      }).setLngLat(coordinates).addTo(map); // Add Popup
      // new mapboxgl.Popup({
      // 	offset: 30
      // })
...
module.exports = {
  ...
  "_spec": "axios@0.21.4",
  "_where": "/Users/weilaibushimeng/Desktop/Prime_Particle",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{}],"getFun.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getAccesser = void 0;
...
var getAccesser = /*#__PURE__*/function () {
  ...
  return function getAccesser(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.getAccesser = getAccesser;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successerfully!"));
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"uploadImg.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.uploadEpaperImg = void 0;
...
var uploadEpaperImg = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = 'https://sakura.qsomula.top/api/v1/EpaperImg/uploadImg';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "updated successerfully!");
            }
  ...
  return function uploadEpaperImg(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.uploadEpaperImg = uploadEpaperImg;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"calendar.js":[function(require,module,exports) {
"use strict";
...
var CALENDAR = /*#__PURE__*/function () {
  function CALENDAR(day) {
    ...
    this.currDay = (0, _moment.default)(day).format('E') * 1;
    this.currWeek = [];
  ...
  _createClass(CALENDAR, [{
    key: "getPreWeek",
    value: function () {
      var _getPreWeek = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var newcurrWeek;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.currWeek.map(function (day) {
      ...
      function getPreWeek() {
        return _getPreWeek.apply(this, arguments);
      }
    ...
    key: "getNextWeek",
    value: function () {
      var _getNextWeek = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var newcurrWeek;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
      ...
      function getNextWeek() {
        return _getNextWeek.apply(this, arguments);
      }
    ...
    key: "getCurrWeek",
    value: function getCurrWeek(dayy) {
      var _this = this;

      _toConsumableArray(Array(this.currDay)).forEach(function (day, index) {
        var today = false;
        var id = _this.currDay - index;
        var newDay = (0, _moment.default)(dayy).subtract(id, 'days');
        var dayofWeek = newDay.format('ddd');
        var monofYear = newDay.format('MMM');
        var dayofMonth = newDay.format('DD');
      ...
      if (this.currDay === 7) {
        var today = true;
        var newDay = (0, _moment.default)(dayy);
        var dayofWeek = (0, _moment.default)(dayy).format('ddd');
        var monofYear = (0, _moment.default)(dayy).format('MMM');
        var dayofMonth = (0, _moment.default)(dayy).format('DD');
        this.currWeek.push({
          today: today,
          dayofWeek: dayofWeek,
          monofYear: monofYear,
        ...
        _toConsumableArray(Array(7 - this.currDay)).forEach(function (day, index) {
          var today;
          index === 0 ? today = true : today = false;
          var newDay = (0, _moment.default)(dayy).add(index, 'days');
          var dayofWeek = newDay.format('ddd');
          var monofYear = newDay.format('MMM');
          var dayofMonth = newDay.format('DD');
...
var epaperImgForm = document.querySelector('.form-epaerImg-data');
var timelinebox = document.querySelector('.section-timelinebox');
var monOfYearRange = document.getElementById('monOfYearRange');
var preWeek = document.getElementById('preWeek');
var nextWeek = document.getElementById('nextWeek');
var reportsList = document.querySelectorAll('.overview-size');
var devicesList = document.querySelector('.devices-list');
var mapBox = document.getElementById('map');
var html = '<li class="devices__item"><span>{{deviceInfo}}</span><span>{{city}}</span></li>';
var htmlActice = '<li class="devices__item active"><span>{{deviceInfo}}</span><span>{{city}}</span></li>';
var timeLineboxHtml = '<a class="section-timelinebox__item {{DayClass}}" href="#" id={{newDay}}><div class="day">{{dayofWeek}}</div><div class="day-number">{{dayofMonth}}</div><div class="day-dot"></div></a>'; // Values
...
var updateTimelineBoxUI = function updateTimelineBoxUI() {
  ...
  timeLineboxData.currWeek.forEach(function (e) {
    if (e.today) {
    ...
    var html2 = html1.replace('{{newDay}}', e.newDay.format());
    var html3 = html2.replace('{{dayofMonth}}', e.dayofMonth);
    var html4 = html3.replace('{{dayofWeek}}', e.dayofWeek);
    newDayHtml += html4;
  });
  ...
  if (timeLineboxData.currWeek[0].monofYear === timeLineboxData.currWeek[6].monofYear) {
    monOfYearRange.textContent = "".concat(timeLineboxData.currWeek[0].monofYear, " ").concat(timeLineboxData.currWeek[0].dayofMonth, "-").concat(timeLineboxData.currWeek[6].dayofMonth);
  } else {
    monOfYearRange.textContent = "".concat(timeLineboxData.currWeek[0].monofYear, " ").concat(timeLineboxData.currWeek[0].dayofMonth, "-").concat(timeLineboxData.currWeek[6].monofYear, " ").concat(timeLineboxData.currWeek[6].dayofMonth);
  }
};
...
if (epaperImgForm) {
  epaperImgForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var imgdata = new FormData();
    imgdata.append('epaper-photo', document.getElementById('epaper-photo').files[0]); // console.log(imgdata);

    (0, _uploadImg.uploadEpaperImg)(imgdata);
  });
}
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 18:
              ...
              reportsList[0].innerHTML = "".concat(stats.length, " Pe");
              reportsList[1].innerHTML = "".concat(numOfPageViews, " Co");
              reportsList[2].innerHTML = "".concat(numOfRobot, " Co");
              reportsList[3].innerHTML = "".concat(stats.length - numOfRobot, " Co");
...
if (preWeek) {
  preWeek.addEventListener('click', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return timeLineboxData.getPreWeek();
...
if (nextWeek) {
  nextWeek.addEventListener('click', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return timeLineboxData.getNextWeek();
