...
var timeLineboxData = new _calendar.CALENDAR();
...
if (timelinebox) {
  ...
  timeLineboxData.currWeek.forEach(function (e) {
    ...
    var html2 = html1.replace('{{newDay}}', e.newDay);
